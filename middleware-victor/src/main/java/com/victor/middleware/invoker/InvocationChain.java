 ...
 *
 * <p>Each call to {@code proceed} returns the terminal handler's typed
 * {@link Message} result (or the result produced by an upstream
 * interceptor that chose not to call {@code proceed}). Interceptors on
 * the way up see the result and can transform or wrap it.</p>
 *
...
public interface InvocationChain {
    Message proceed(InvocationContext ctx) throws InvocationAbortedException;
}